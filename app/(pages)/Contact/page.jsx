...
6 13.0637 6 9C6 5.68629 8.68629 3 12 3C15.3137 3 18 5.68629 18 9ZM13 9C13 9.55228 12.5523 10 12 10C11.4477 10 11 9.55228 11 9C11 8.44772 11.4477
 8 12 8C12.5523 8 13 8.44772 13 9Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</div>
              </div>
          ...
          <div className='grid md:grid-cols-2 py-40'>
            ...
            <div className=' bg-[#eef4f2] ' id='mail'>
              ...
              <div>
                  ...
                  <input type='text' placeholder='Genesis Artiste' className='block w-full p-2 rounded-md' name='name'/>
                </div>
                <div>
                  <label className='text-sm md:text-base'>Phone Number</label>
                  <input type='tel' placeholder='+233240000000' className='block w-full p-2 rounded-md' name='number'/>
                </div>
                <div>
                  <label className='text-sm md:text-base'>Email Address</label>
                  <input type='text' placeholder='john@example.com' className='block w-full p-2 rounded-md' name='email'/>
                </div>
                <div>
                  <label className='text-sm md:text-base'>Subject</label>
                  <input type='text' placeholder='Branding' className='block w-full p-2 rounded-md' name='subject'/>
                </div>
              </div>
            
              <div className='p-5 col-span-2 '>
              <label className='text-sm md:text-base'>Message</label>
                <textarea className='block w-full h-[30vh]' name='message'/>
              </div>
              <div className='p-5'>
<SubmitButton/>
              </div>
