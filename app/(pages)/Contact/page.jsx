        ...
        <div className='max-w-screen-2xl px-5 mx-auto  pt-20 '>
          <div className='grid md:grid-cols-3 gap-10 '>
            ...
            <div className='space-y-5'>
              <p className='text-3xl'>Ready to work with us?</p>
              <button className='bg-gold font-semibold px-5 py-2 rounded-full text-nowrap'>
                Get In Touch 
              </button>
              <div className='flex gap-5'>
<div>
<svg width="80px" height="80px" viewBox="0 0 24 24" fill="none" className='socials' >
...
<div className='flex justify-center items-center'>
  <svg width="60px" height="60px" viewBox="0 -2 20 20" version="1.1" className='socials' >
...
<div className='border border-black -mt-5 bg-latest bg-[#eef4f2] p-5 flex justify-center items-center '>
  ...
  <p>Oyarifa, Ghana</p>
          ...
          <div className='grid md:grid-cols-2 py-40'>
            <div className='bg-latest bg-cover'>Map</div>
            <div className=' bg-[#eef4f2] '>
              <form>
                <p className='p-5 font-semibold text-3xl'>Send Us A  Message</p>
              ...
              <label>Message</label>
                <textarea className='block w-full h-[30vh]'/>
              </div>
              <div className='p-5'>
              <button className='bg-gold font-semibold px-5 py-2 rounded-full text-nowrap'>
                Send Message
